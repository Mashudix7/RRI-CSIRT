                    ...
                    <?php foreach ($incidents as $incident): ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="<?= base_url('incidents/' . $incident['id']) ?>" 
                                   class="inline-flex items-center gap-1 px-3 py-1.5 text-sm text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-500/20 rounded-lg transition-colors">
                                    <span>Detail</span>
